...
void telaInicial(){
    ...
    printf("\n");
    bordaVertical(219);
    printf("\tExplore a emocao e desafio da vida rural com o jogo \"Milk Stacking Challenge\"!\n");
    bordaVertical(219);
    printf("\n");
    bordaVertical(219);
    printf("    Assuma o papel de um gerente de fazenda encarregado de preservar o frescor do leite recem \n");
    bordaVertical(219);
    printf("ordenhado.\n");
    bordaVertical(219);
    printf("Enfrente um emocionante desafio quando o refrigerador onde o leite esta armazenado apresenta defeito. \n");
    bordaVertical(219);
    printf("    Sua missao: transferir as caixas de leite empilhadas em forma de piramide para outro refrigerador, \n");
    bordaVertical(219);
    printf("mantendo a estrutura, movendo cada caixa de um para outro sem deixa-las fora do refrigerador por muito\n");
    bordaVertical(219);
    printf("tempo, evitando a deterioracão do leite, de forma que todas as caixas fiquem empilhadas novamente no \n");
    bordaVertical(219);
    printf("terceiro refrigerador.\n");
    bordaVertical(219);
    printf("    Comande a operação com agilidade e estratégia, escolhendo o refrigerador ideal e movendo as \n");
    bordaVertical(219);
    printf("caixas com precisão. \n");
    bordaVertical(219);
    printf("Cada movimento importa, cada decisao impacta o resultado. O frescor do leite está em suas maos.");
    getch();
}
